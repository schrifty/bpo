...
| Auth | Preferred `LEANDNA_DATA_API_API_KEY` (Auth session); else `LEANDNA_DATA_API_BEARER_TOKEN` or `LEANDNA_DATA_API_COOKIE` — see [`../SETUP/LEANDNA_SETUP.md`](../SETUP/LEANDNA_SETUP.md) |
