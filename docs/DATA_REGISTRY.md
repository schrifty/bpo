...
|---|---|---|---|---|
| `JIRA-JQL-ISSUE-SEARCH` | Primary issue retrieval surface for customer, project, and trend reporting. | `POST /rest/api/3/search/jql` | `docs/JIRA_DATA_SCHEMA.md`, `src/jira_client.py` | Core surface |
| `JIRA-SERVICE-DESK-ORGANIZATIONS` | JSM organization objects used for customer matching. | `customfield_10502`, JSM organization records | `docs/JIRA_DATA_SCHEMA.md`, `src/jira_client.py` | Core surface |
| `JIRA-ASSET-SITE-ENTITY-REFERENCE` | CMDB object references for site and entity on issues. | `customfield_11121`, `customfield_11154` | `docs/JIRA_DATA_SCHEMA.md`, `src/jira_client.py` | `UNUSED` in most slide logic |
...
| `JIRA-SATISFACTION-SCORE` | JSM customer satisfaction score. | `customfield_10609` | `docs/JIRA_DATA_SCHEMA.md` | `UNUSED` |
| `JIRA-TIME-TO-DONE` | Additional SLA metric available in the instance. | `customfield_10815` | `docs/JIRA_DATA_SCHEMA.md` | `UNUSED` |
| `JIRA-PENDING-REASON` | Reason a ticket is waiting. | `customfield_10641` | `docs/JIRA_DATA_SCHEMA.md` | `UNUSED` |
| `JIRA-RESOLUTION-TYPE` | How a ticket was resolved. | `customfield_10679` | `docs/JIRA_DATA_SCHEMA.md` | `UNUSED` |
| `JIRA-CSM-FREE-TEXT` | Free-text CSM field on Jira issues. | `customfield_11220` | `docs/JIRA_DATA_SCHEMA.md` | `UNUSED`, `WRONG-SOURCE?` |
...
| Identifier | Description | Source field / query surface | Where used | Status note |
|---|---|---|---|---|
| `PENDO-VISITORS-SOURCE` | Visitor metadata source for account, role, site, and activity. | Aggregation source `visitors` | `docs/PENDO_DATA_SCHEMA.md`, `src/pendo_client.py` | Core surface |
| `PENDO-ACCOUNTS-SOURCE` | Account metadata source. | Aggregation source `accounts` | `docs/PENDO_DATA_SCHEMA.md`, `src/pendo_client.py` | Core surface |
| `PENDO-PAGE-EVENTS-SOURCE` | Page interaction event stream. | Aggregation source `pageEvents` | `docs/PENDO_DATA_SCHEMA.md`, `src/pendo_client.py` | Core surface |
| `PENDO-FEATURE-EVENTS-SOURCE` | Feature interaction event stream. | Aggregation source `featureEvents` | `docs/PENDO_DATA_SCHEMA.md`, `src/pendo_client.py` | Core surface |
| `PENDO-GUIDE-EVENTS-SOURCE` | Guide lifecycle events such as seen, advanced, dismissed. | Aggregation source `guideEvents` | `docs/PENDO_DATA_SCHEMA.md`, `src/pendo_client.py` | Core surface |
| `PENDO-POLL-EVENTS-SOURCE` | Poll and NPS response event stream. | Aggregation source `pollEvents` | `docs/PENDO_DATA_SCHEMA.md` | `UNUSED` by app today |
| `PENDO-TRACK-EVENTS-SOURCE` | Custom app track events. | Aggregation source `events` | `docs/PENDO_DATA_SCHEMA.md`, `src/pendo_client.py` | Used for Kei fallback |
| `PENDO-PAGE-CATALOG` | Page catalog used to map page IDs to readable names. | `GET /page` | `docs/PENDO_DATA_SCHEMA.md`, `src/pendo_client.py` | Core surface |
| `PENDO-FEATURE-CATALOG` | Feature catalog used to map feature IDs to readable names. | `GET /feature` | `docs/PENDO_DATA_SCHEMA.md`, `src/pendo_client.py` | Core surface |
| `PENDO-GUIDE-CATALOG` | Guide catalog used to map guide IDs to readable names. | `GET /guide` | `docs/PENDO_DATA_SCHEMA.md`, `src/pendo_client.py` | Core surface |
| `PENDO-TRACK-TYPE-CATALOG` | Track-event type catalog. | `GET /tracktype` | `docs/PENDO_DATA_SCHEMA.md` | `UNUSED` |
| `PENDO-REPORT-CATALOG` | Saved report catalog. | `GET /report` | `docs/PENDO_DATA_SCHEMA.md` | `UNUSED` |
| `PENDO-SEGMENT-CATALOG` | Segment catalog. | `GET /segment` | `docs/PENDO_DATA_SCHEMA.md` | `UNUSED` |
...
| `PENDO-SITE-ID` | Site identifier attached to a visitor. | `metadata.agent.siteid`, `siteids` | `docs/PENDO_DATA_SCHEMA.md`, `src/pendo_client.py` | Core field |
...
| `PENDO-LANGUAGE` | User language setting. | `metadata.agent.language` | `docs/PENDO_DATA_SCHEMA.md` | `UNUSED` |
...
| `PENDO-FIRST-VISIT-TIMESTAMP` | First visit timestamp for visitor/account. | `metadata.auto.firstvisit` | `docs/PENDO_DATA_SCHEMA.md`, `src/pendo_client.py` | Core field |
...
| `PENDO-NPS-SCORE` | NPS response data from polls. | `pollEvents.pollResponse`, `pollType` | `docs/PENDO_DATA_SCHEMA.md`, `docs/USAGE_DATA_PRIORITIES.md` | `UNUSED`, `MISSING` from current deck outputs |
| `PENDO-FRUSTRATION-SIGNALS` | Rage clicks, dead clicks, error clicks, U-turns by page/feature/account. | Event fields `rageClickCount`, `deadClickCount`, `errorClickCount`, `uTurnCount` | `docs/PENDO_DATA_SCHEMA.md`, `docs/USAGE_DATA_PRIORITIES.md` | `UNUSED`, high-value candidate |
...
| Identifier | Description | Source field / query surface | Where used | Status note |
|---|---|---|---|---|
| `CSR-LATEST-EXPORT-FILE` | Latest XLSX export from the shared drive. | Google Drive export of newest file in Data Exports folder | `src/cs_report_client.py` | Core surface |
