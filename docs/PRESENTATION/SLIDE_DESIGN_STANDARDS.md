...
- Label and value use equal vertical inset (`KPI_METRIC_PAD_V`, 8 pt) from the card edges; value sits in a bottom-anchored line box (not a stretched full-height box).
