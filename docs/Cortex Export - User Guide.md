...
| **Prior-month archives** | `…/Historical Data/{YYYY-MM}/{YYYY-MM-DD}/` | Rolled up at process startup. Months ≥2 calendar months old keep only the **1st**; days 2–end are permanently deleted |
...
### CSR entity-week portfolio (Output/)
