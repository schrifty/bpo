...
def create_pendo_agent(
    ...
    default_prompt = (
        ...
        "LEANDNA DATA API (optional — set LEANDNA_DATA_API_API_KEY, or BEARER_TOKEN / COOKIE):\n"
        ...
        "Blocked when EXECUTION_ENV is Production/CI unless CORTEX_ALLOW_PRODUCTION_MUTATIONS=true.\n"
