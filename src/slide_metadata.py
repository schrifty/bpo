...
SLIDE_DATA_REQUIREMENTS: dict[str, list[str]] = {
    ...
    "eng_current_sprint": ["eng_portfolio"],
    "eng_flow_bottlenecks": ["eng_portfolio"],
    "eng_work_split": ["eng_portfolio"],
    "eng_backlog_health": ["eng_portfolio"],
    "eng_capacity": ["eng_portfolio"],
    "eng_sprint_snapshot": ["eng_portfolio"],
    "eng_epic_progress": ["eng_portfolio"],
    ...
    "cursor_efficiency_engineers": ["cursor_usage"],
    "cursor_users_volume": ["cursor_usage"],
    "cursor_users": ["cursor_usage"],
    "cursor_users_light": ["cursor_usage"],
    "cursor_users_non_engineers_volume": ["cursor_usage"],
    "cursor_users_non_engineers": ["cursor_usage"],
    "cursor_users_non_engineers_light": ["cursor_usage"],
    "github_engineering_output": ["github_productivity"],
    "github_engineer_contribution": ["github_productivity"],
    "github_delivery_flow": ["github_productivity"],
    "github_change_profile": ["github_productivity"],
    "productivity_summary": ["github_productivity", "ai_productivity", "cursor_usage"],
    "productivity_trend": ["github_productivity", "ai_productivity", "cursor_usage"],
    "productivity_coaching": ["github_productivity", "ai_productivity", "cursor_usage"],
    "ai_output_correlation": ["github_productivity", "ai_productivity", "cursor_usage"],
    "ai_productivity_matrix": ["github_productivity", "ai_productivity", "cursor_usage"],
    "support_deck_cover": [],
    "support_intro": [],
    "support_kpis_intake": ["jira"],
    "support_kpis_flow": ["jira"],
    "support_kpis_backlog": ["jira"],
    "support_kpis_tail_risk": ["jira"],
    "support_kpis_sla": ["jira"],
    "support_kpis_ttfr": ["jira"],
    "support_kpis_resolution": ["jira"],
    "support_kpis_engineering_dependency": ["jira"],
    "support_kpis_escalation_backlog_engineering": ["jira"],
    "support_kpis_escalation_backlog_data_integration": ["jira"],
    "support_kpis_customer_health": ["jira"],
    "support_kpis_csat": ["jira"],
    "support_kpis_aging_thresholds": ["jira"],
    "support_kpis_notable": ["jira"],
    "cs_notable": ["jira"],
...
def ordered_dq_data_sources_for_slide_plan(slide_plan: list[dict[str, Any]] | None) -> list[str] | None:
    ...
    for entry in slide_plan or ():
        ...
        if slide_type in ("", "data_quality", "eng_divider"):
            continue
