...
Usage:
    python run_decks.py cs_health_review
    python run_decks.py cs_health_review --quarter Q4 2025
    python run_decks.py product_adoption --days 60 --max 10 --workers 2
...
def main():
    ...
    if fail:
        ...
        retry_cmd = f"python run_decks.py {args.deck} {q_flag} --customers {' '.join(failed_names)}"
